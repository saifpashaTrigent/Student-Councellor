...
class Stories(BaseModel):
    ...
    limit: int = Field(
        default=5, description="The number of stories to return. Defaults to 5."
    )
    keywords: List[str] = Field(
        default=None,
        description="The list of keywords to filter the stories. " "Defaults to None",
    )
    story_type: str = Field(
        default="top",
        description="The story type. It can be one of the following: "
...
class Comments(BaseModel):
    ...
    limit: int = Field(
        default=10, description="The number of comments to return. Defaults to 10."
    )
